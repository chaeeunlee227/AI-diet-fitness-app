        ...
        return (
          <div key={meal.key} className="card">
            ...
            {mealLogs.map((log) => (
              <div
                key={log.id}
                className="flex items-center gap-3 py-2 border-t border-gray-50 group"
              >
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-3 mb-3">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="text-right">
                        ...
                        <div
                          className={`text-xs ${aiResult.confidence === "high" ? "text-green-600" : aiResult.confidence === "medium" ? "text-amber-600" : "text-red-500"}`}
                        >
                    ...
                    <div className="flex gap-4 text-xs text-gray-500">
                      <span>
                        Protein:{" "}
                        <b className="text-gray-700">{aiResult.protein_g}g</b>
                      </span>
                      <span>
                        Carbs:{" "}
                        <b className="text-gray-700">{aiResult.carbs_g}g</b>
                      </span>
                      <span>
                        Fat: <b className="text-gray-700">{aiResult.fat_g}g</b>
                      </span>
                    </div>
                    {aiResult.notes && (
